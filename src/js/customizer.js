...
jQuery(document).ready(function ($) {
    ...
    const $bannerBtn = $('<button class="bmc-banner__edit-btn">' + pencilSvg + '<span class="bmc-banner__edit-btn-label">Edit cover</span></button>');
    ...
    function openBannerEdit() {
        ...
        $bannerBtn.addClass('bmc-banner__edit-btn--active').html(pencilSvg + '<span class="bmc-banner__edit-btn-label">Done</span>');
